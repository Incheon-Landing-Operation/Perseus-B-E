...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
  ...
  public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
    ...
    return new CustomOAuth2User(
            Collections.singleton(new SimpleGrantedAuthority(createdUser.getRole().getRoleKey())),
            attributes,
  ...
  private User getUser(OAuthAttributes attributes, SocialType socialType) {
    User user = userRepository.findBySocialTypeAndSocialId(socialType,
            ...
            .orElseGet(() -> userRepository.save(attributes.toEntity(socialType, attributes.getOauth2UserInfo())));
    return user;
  }
